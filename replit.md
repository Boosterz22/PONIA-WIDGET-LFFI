...
*   **Core Technical Implementations:**
    ...
    *   **Admin Dashboard:** Tools for user management, real-time statistics, CSV export, secured by httpOnly JWT cookies (24h expiration). Includes commercial tracking dashboard for referrer performance.
    *   **Accountant Partner Program:** Dedicated partner landing page (/partenaires/comptables) for accountants with 50% recurring commission. Partners get unique CPT-XXXXXX referral codes, dedicated dashboard (/partenaire/dashboard), client tracking, commission calculations, and CSV export. Welcome email sent via Resend with referral link and dashboard access.
