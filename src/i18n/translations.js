const translations = {
  ...
  ar: {
    ...
    order: {
      title: 'طلب ذكي',
      subtitle: 'قام PONIA بتحليل مخزونك وتوليد طلب محسّن. اختر كيفية إرساله:',
      downloadPDF: 'تنزيل PDF',
      copyWhatsApp: 'نسخ لـ WhatsApp',
      sendEmail: 'إرسال بالبريد الإلكتروني',
      generating: 'جاري التوليد...',
      pdfGenerated: 'تم توليد PDF!',
      copied: 'تم النسخ!',
      emailSent: 'تم إرسال البريد!',
      timeSaving: 'توفير الوقت: قام PONIA بتحليل مخزونك وحساب الكميات المثلى وتوليد الطلب. توفر أكثر من 50 دقيقة!'
    }
  },
  de: {
    nav: {
